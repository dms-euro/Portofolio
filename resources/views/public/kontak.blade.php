           ...
           flex items-center justify-center mx-auto overflow-hidden">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                            ...
                            <div>
                                <a href="mailto:uroprasetyo@gmail.com">
                                    <div class="text-sm text-gray-400">Email</div>
                                    <div class="font-medium">uroprasetyo@gmail.com</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                            ...
                            <div>
                                <a href="https://wa.me/62882006533693">
                                    <div class="text-sm text-gray-400">WhatsApp</div>
                                    <div class="font-medium">+62 8820-0653-3693</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                            ...
                            <div>
                                <a href="https://www.instagram.com/dms_euro/">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            <a href="https://linktr.ee/dms_euro"
                                class="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors text-center">
                                <i class="fas fa-link text-xl text-sky-400"></i>
                            </a>
                            <a href="teer.id/dms_euro"
                                class="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors text-center">
            ...
            <div data-aos="fade-left">
                <div
                    ...
                    <form class="p-4" action="{{ route('kirim.pesan') }}" method="POST">
                        @csrf
                        <div class="space-y-6">
                            <!-- Name Field -->
                            <div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input name="email" type="email" placeholder="email@anda.com" required
                                        class="w-full pl-10 pr-4 py-3 bg-gray-900/50 border border-gray-700
                                                      rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500
                                                      placeholder-gray-500">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="bg-gray-900/50 border border-gray-700 rounded-xl overflow-hidden">
                                        <textarea name="pesan" id="messageInput" placeholder="Tulis pesan Anda di sini..." rows="6" required
        ...
        <div
            ...
            <div>
                ...
                <div class="flex justify-center gap-3">
                    ...
                    <a href="#" class="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors text-center">
                        <i class="fab fa-linkedin text-xl text-blue-400"></i>
                    </a>
                    <a href="https://linktr.ee/dms_euro"
                        class="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors text-center">
